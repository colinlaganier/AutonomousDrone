...
bool configure_beacons()
{
    ...
    if (get_remote_range(anchor_id[0], anchor_id[1], x_range)) {
        set_beacon_position(1, x_range, 0, anchors_z[1]);
    } else {
    ...
    if (get_remote_range(anchor_id[0], anchor_id[2], y_range)) {
        set_beacon_position(2, 0, y_range, anchors_z[2]);
    } else {
    ...
    if (x_range != 0 && y_range != 0) {
        set_beacon_position(3, x_range, y_range, anchors_z[3]);
    } else {
